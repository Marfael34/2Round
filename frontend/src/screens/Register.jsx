            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} className="bg-[#1A1A1A] border border-white/10 rounded-sm p-3 text-white focus:border-red-600 focus:outline-none font-inter text-sm" required />
                </div>
              </div>
            </>
          )}
