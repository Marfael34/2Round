...
import { BookOpen, Shield, ShieldCheck, Sword, User, Play, Activity, AlertTriangle } from 'lucide-react';
...
const videoCategories = [
  { id: 'posture', label: 'Posture & Garde', icon: <User className="w-4 h-4 mr-2" /> },
  { id: 'safety', label: 'Sécurité & Prévention', icon: <AlertTriangle className="w-4 h-4 mr-2" /> },
  { id: 'defense', label: 'Techniques de Défense', icon: <Sword className="w-4 h-4 mr-2" /> }
];

// Liens directs vers YouTube
const videos = {
  posture: [
    { title: "La position de boxe: Un guide étape par étape pour les débutants", url: "https://www.youtube.com/watch?v=7G-MWsjC6xE", channel: "Boxing Ready" }
  ],
  safety: [
    { title: "How to Wrap Hands (The Best Way)", url: "https://www.youtube.com/watch?v=CMS_ni5lEs4", channel: "Tony Jeffries" }
  ],
  defense: [
    { title: "Boxing Defense 101", url: "https://www.youtube.com/watch?v=0XpEc7Qk9bk", channel: "BOWING FACTORY TV" },
  ]
};
    ...
    <div className="min-h-screen bg-black text-white py-16 px-4 sm:px-6 lg:px-8 font-inter">
      ...
      <div className="max-w-[960px] mx-auto text-center mb-24 mt-8">
        ...
        <p className="max-w-2xl mx-auto text-lg font-light text-gray-400">
          Maîtrisez les fondamentaux, apprenez à vous protéger et progressez en toute sécurité grâce à nos ressources pour débutants.
        </p>
      </div>
      ...
      <div className="max-w-[960px] mx-auto space-y-28">
        ...
        <section>
          <div className="flex items-center space-x-4 mb-10 pb-4 border-b border-white/10">
            ...
            <h2 className="font-bebas text-4xl tracking-wider text-white uppercase">Conseils Essentiels</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {adviceGuides.map((guide, idx) => (
              ...
              >
                ...
                <h3 className="font-bebas text-3xl tracking-wide text-white mb-5 uppercase">{guide.title}</h3>
                <ul className="space-y-3 grow">
                  {guide.tips.map((tip, i) => (
                    <li key={i} className="flex items-start">
                      <span className="text-red-500 mr-3 mt-1 text-xs">■</span>
                      <span className="text-gray-400 text-sm font-light leading-relaxed">{tip}</span>
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <section className="pb-20">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 pb-4 border-b border-white/10 gap-6">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="font-bebas text-4xl tracking-wider text-white uppercase">Ressources Vidéo</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {videos[activeTab].map((video, idx) => (
              ...
              >
                ...
                <p className="text-gray-500 text-sm font-light mt-auto">Source : {video.channel}</p>
