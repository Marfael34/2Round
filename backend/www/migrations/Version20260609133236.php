 ...
 */
final class Version20260609133236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adress (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, street_number VARCHAR(10) NOT NULL, street_name VARCHAR(255) NOT NULL, postal_code VARCHAR(5) NOT NULL, city VARCHAR(100) NOT NULL, country VARCHAR(50) NOT NULL, latitude NUMERIC(10, 8) NOT NULL, longitude NUMERIC(11, 8) NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_5CECC7BEA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, number VARCHAR(50) NOT NULL, totalprice NUMERIC(12, 2) NOT NULL, shipping_fees INT NOT NULL, services_fees INT NOT NULL, status VARCHAR(25) NOT NULL, created_at DATETIME NOT NULL, stripe_payment_intent_id VARCHAR(255) DEFAULT NULL, stripe_tansfer_id VARCHAR(255) DEFAULT NULL, weight_total NUMERIC(5, 2) DEFAULT NULL, shipping_label_url VARCHAR(255) DEFAULT NULL, tracking_number VARCHAR(50) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, reason VARCHAR(50) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, status VARCHAR(20) DEFAULT \'pending\' NOT NULL, sender_id INT DEFAULT NULL, orderid_id INT DEFAULT NULL, conversation_id INT DEFAULT NULL, message_id INT DEFAULT NULL, product_id INT DEFAULT NULL, reported_user_id INT DEFAULT NULL, INDEX IDX_C42F7784F624B39D (sender_id), INDEX IDX_C42F77846F90D45B (orderid_id), INDEX IDX_C42F77849AC0396 (conversation_id), INDEX IDX_C42F7784537A1329 (message_id), INDEX IDX_C42F77844584665A (product_id), INDEX IDX_C42F7784E7566E (reported_user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
