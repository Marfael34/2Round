...
class InvoiceService
{
    ...
    public function generateBoostInvoice(Invoice $invoice, \App\Entity\Product $product, User $userTarget): void
    {
        $pdfDir = __DIR__ . '/../../public/invoice';
        if (!is_dir($pdfDir)) {
            mkdir($pdfDir, 0777, true);
            ...
            <div class='container'>
                ...
                <table class='billing-table'>
                    <tr>
                        <td style='width: 50%; padding-right: 20px;' class='client-info'>
                            ...
                            <p class='client-name'>2ROUND</p>
                            <p>contact@2round.fr</p>
                        </td>
                        <td style='width: 50%;' class='client-info'>
                ...
                <table class='items-table'>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <strong>Option Visibilité (Boost)</strong>
                                <div class='item-desc'>Mise en avant du produit : {$productName}</div>
                            </td>
                ...
                <div class='footer'>
                    <strong>L'article n'est pas assujetti à la TVA (art. 293 B du CGI ou équivalent).</strong><br>
                    Merci pour votre confiance !<br>
                    Ce document est généré électroniquement et sert de preuve de transaction.
                </div>
            </div>
